...
namespace P_TECNICA.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUsuarios,Username,Pass,Nombre,Fnacimiento,Email")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("IdUsuarios,Username,Pass,Nombre,Fnacimiento,Email")] Usuario usuario)
        {
